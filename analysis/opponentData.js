...
function OpponentData(side, type, nik,country, newType){ 
	this.oppType = type;
	this.type = newType;
...
OpponentData.prototype = {
	...
	initializeOpponentData: function(){
		var tasks;
		if(this.type && this.type == "newOffers"){
			tasks = readCFGfile(this.oppSide, this.oppType,this.type);
			console.log(this.type);
		}
		else
			tasks = readCFGfile(this.oppSide, this.oppType,this.country);
